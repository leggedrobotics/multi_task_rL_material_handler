...
It renames all the occurrences of multi_task_rL_material_handler (in files, directories, etc.) to the new project name.
"""
...
if __name__ == "__main__":
    ...
    old_name = "multi_task_rL_material_handler"
    new_name = sys.argv[1]
    ...
    if proceed.lower() == "y":
        # rename the multi_task_rL_material_handler folder
        os.rename(
            os.path.join(root_dir_path, "exts", "multi_task_rL_material_handler", "multi_task_rL_material_handler"),
            os.path.join(root_dir_path, "exts", "multi_task_rL_material_handler", new_name),
        )
        os.rename(os.path.join(root_dir_path, "exts", "multi_task_rL_material_handler"), os.path.join(root_dir_path, "exts", new_name))
