...
class MaterialHandlerRLEnv(ManagerBasedRLEnv):
    ...
    def __init__(self, cfg: MaterialHandlerEnvCfg, render_mode: str | None = None, **kwargs): 
        ...
        self.slew_scale = cfg.materialhandlerquantities.action_slew_scale
        self.boom_stick_scale = cfg.materialhandlerquantities.action_boom_stick_scale
        self.slew_clamp = cfg.materialhandlerquantities.action_slew_clamp
        self.boom_stick_clamp = cfg.materialhandlerquantities.action_boom_stick_clamp
        
        # Vizualization
        if self.sim.has_gui():
            import omni.isaac.debug_draw._debug_draw as omni_debug_draw
            from .material_handling_utils.vizualization_material_handling import define_markers
            # Markers
            self.visualizer = define_markers()
            # Lines
    ...
    def pre_physics_step(self, action):
        ...
        self.action_manager.process_action(self.target_joint_vel)
