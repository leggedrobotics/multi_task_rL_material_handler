...
def some_public_function(x: int):
    print("[multi_task_rL_material_handler] some_public_function was called with x: ", x)
    return x**x
...
class ExampleExtension(omni.ext.IExt):
    ...
    def on_startup(self, ext_id):
        print("[multi_task_rL_material_handler] startup")
    ...
    def on_shutdown(self):
        print("[multi_task_rL_material_handler] shutdown")
